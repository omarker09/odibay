...
function Product(props) {
  ...
  return (
    <div key={props.id} className=' boxshadow duration-200 flex flex-col justify-between cursor-pointer  relative  w-full rounded-lg' >
        ...
        <div className=' flex flex-col gap-1 select-none nodrag p-2 w-full justify-start items-start'>
          ...
          <div className=' flex flex-col gap-2 items-start w-full justify-between'>
            ...
            <div className=' flex items-center gap-3 w-full justify-between px-0 md:px-1 lg:px-0'>
              <button className={theme !== "dark" ? ' w-full duration-300 hover:opacity-70 orange-background text-xs lg:text-sm  px-1 md:px-3 lg:px-2 py-2 text-black rounded flex items-center gap-3 justify-center' : ' w-full duration-300 hover:opacity-70 orange-background flex items-center justify-center text-xs lg:text-sm gap-3  px-1 md:px-3 lg:px-2 py-2 text-black rounded'}>View <FaArrowCircleRight /></button>
              <button className={theme !== "dark" ? ' w-full duration-300 hover:opacity-70 orange-background text-xs lg:text-sm  px-1 md:px-3 lg:px-2 py-2 text-black rounded flex items-center gap-3 justify-center' : ' w-full duration-300 hover:opacity-70 orange-background text-xs lg:text-sm  px-1 md:px-3 lg:px-2 py-2 text-black rounded gap-3 flex items-center justify-center'}>Add <FaCartShopping /></button>
            </div>
          </div>
        </div>
      </div>
