...
function Sectionads3() {
    ...
    return (
        <div className={theme !== "dark" ? ' w-full flex px-2 sm:px-10 md:px-16 lg:px-20 bg-white items-center justify-center py-6 ' : ' w-full flex px-2 sm:px-10 md:px-16 lg:px-20 cart-box  items-center justify-center py-6 '}>
