...
function Trusted() {
  return (
    <div className="bg-black  px-2 py-4 sm:px-10 md:px-16 lg:px-20 items-center justify-center gap-3 sm:justify-between h-44 flex ">
      ...
      <span
        style={{ width: 1 }}
        className=" h-full trst-one bg-gray-800"
      ></span>
      ...
      <span
        style={{ width: 1 }}
        className=" h-full trst-two bg-gray-800"
      ></span>
      <div className=" trst-three items-center gap-3 py-5">
        ...
        <div>
          ...
          <p className=" text-gray-400 text-lg md:text-base lg:text-lg">
            Human support 24/7
          </p>
        </div>
      </div>
      <span
        style={{ width: 1 }}
        className=" h-full trst-three bg-gray-800"
      ></span>
