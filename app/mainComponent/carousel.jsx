...
import SteamLight from "../../public/steam.svg"
import SteamDark from "../../public/steam-black.svg"
...
return (
  <div className=' w-full h-full flex py-10  items-center  justify-between'>
    ...
    <div className=' w-full  flex justify-between flex-col gap-3 h-full'>
      ...
      <div style={{ height: 400 }} className={`w-full duration-300 box-large ${bgColorClassTheme} flex items-start justify-between boxsh2 `}>
        ...
        <div style={{ width: 450 }} className='  flex flex-col gap-4  justify-start h-full items-start p-4 '>
          <div className=' flex w-full items-center justify-between'>
            <div className=' relative bg-green-600 flex overflow-hidden'>
              ...
              <span style={{ marginRight: -20, marginBottom: -25 }} className='  bottom-0 right-0 px-7 cart-box  badgeslash'></span>
            </div>
          ...
          <div className=' w-full flex h-full items-end  justify-between'>
