        ...
        >
          {data.map((el, index) => (
            <div
              ...
              className={
                theme !== "dark"
                  ? " border border-gray-200 min-w-full h-full flex flex-col lg:flex-row items-center justify-between"
                  : "   min-w-full h-full flex flex-col lg:flex-row items-center justify-between"
              }
            >
              <img
                src={el.src}
              ...
              <div
                className={
                  theme !== "dark"
                    ? "h-full duration-300 w-full lg:w-3/6 bg-white flex gap-3 p-5 rounded-b-md lg:rounded-e-md   items-start justify-between flex-col "
                    : "h-full w-full duration-300 lg:w-3/6 cart-box  flex gap-3 p-5 rounded-b-md lg:rounded-e-md  items-start justify-between flex-col "
                }
              >
                <div className=" w-full  items-start gap-3 flex flex-col">
                  ...
                  <div className=" w-full flex items-center gap-2">
                    <button className="tags-theme p-1 opacity-80 hover:opacity-100 hover:text-white duration-200 px-2 rounded-xl text-xs shadow-sm text-gray-200">
                      Action
                    </button>
                    <button className="tags-theme p-1 opacity-80 hover:opacity-100 hover:text-white duration-200 px-2 rounded-xl text-xs shadow-sm text-gray-200">
                      RolePlay
                ...
                <div>
                  ...
                  >
                    ...
                    Numquam eum minus magni voluptatum pis atque optio, odit
                    iure repellat, maxime repellendus, totam sequi..."
                  </p>
                ...
                <div className=" w-full flex items-center justify-between">
                  ...
                  <div>
                    <button className="orange-background flex items-center p-2 justify-between px-10 rounded-md">
                      View <ArrowRightIcon className=" text-lg" />
                    </button>
                  </div>
                </div>
              </div>
