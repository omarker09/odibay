...
export default function SignIn() {
  ...
  async function SaveBilBillAddressServer() {
    ...
    if (
      ...
      axios
        .post(
          "http://localhost:3002/api/v1/auth/usr/inf/addrr",
          {
            email: email,
            user_id: user_id,
            first_name: firstName,
    ...
    if (!emSt) {
      ...
      try {
        ...
        if (Array.isArray(tbg) && tbg.length > 0) {
          ...
          axios
            .post(
              "http://localhost:3002/api/v1/auth/usr/cltk",
              {
                email: gl,
              },
              {
  ...
  async function updateAvatar() {
    ...
    axios
      .post(
        "http://localhost:3002/api/v1/auth/usr/avats/update",
        {
          email: email_str,
          user_id: user_id_str,
  ...
  function handleChangePwd() {
    if (!password || !password2) {
      ...
      axios
        .post(
          "http://localhost:3002/api/v1/auth/usr/inf/update",
          {
            email: email_str,
            user_id: user_id_str,
            username: username,
    ...
    <div>
              ...
              <div className=" w-full flex gap-y-3 items-center justify-center flex-col">
                ...
                <div>
                  <button
                    ...
                    className=" bg-orange-500 py-2 rounded-md px-4 text-white"
                  >
                    Change Avatar
                  </button>
                </div>
                ...
                <CustomTabPanel value={value} index={0}>
                  <div
                    className={
                      errorType2 === ""
                        ? "hidden"
                        : " w-full rounded-md flex items-center justify-start px-4  outline outline-1 bg-red-100 outline-red-300"
                    }
                  >
                  ...
                  <div className=" w-full pb-4 flex items-center justify-center">
                    <div
                      className={
                        seccType2 === ""
                          ? "hidden"
                          : " w-full rounded-md flex items-center justify-start px-4  outline outline-1 bg-green-200 outline-green-500"
                      }
                    >
                      <div className=" h-full flex items-center justify-center gap-x-3 py-3">
                  ...
                  <div className="w-full flex items-center">
                    <button
                      onClick={() => {
                        SaveBilBillAddressServer();
                      }}
                      className="w-40 p-2 bg-black rounded-lg  flex items-center justify-center gap-x-2 text-white"
                    >
                      {loading2 ? (
                        <CircularProgress
                    ...
                    <div className=" w-full h-10 flex items-center justify-start">
                      <Lottie
                        className={turnOnAnim ? " h-40 w-40" : "hidden"}
                        size={10}
                        animationData={SentAnim}
                        autoPlay={turnOnAnim ? true : false}
                        loop={turnOnAnim ? true : false}
                      />
                    </div>
                  </div>
                </CustomTabPanel>
                  ...
                  <div className=" bg-white flex flex-col justify-between gap-y-5 w-full p-2 h-full sm:h-auto">
                    ...
                    <div className=" flex flex-col gap-y-4 w-full">
                      <div className=" flex flex-col gap-y-3 w-full">
                        ...
                        <input
                          ...
                          className=" p-3 border-none outline outline-1 cursor-not-allowed  bg-gray-200  outline-gray-300 rounded-md"
                          type="text"
                      ...
                      <div className=" flex flex-col gap-y-3 w-full">
                        ...
                        <input
                          ...
                          className=" p-3 border-none cursor-not-allowed outline outline-1  outline-gray-300 rounded-md bg-gray-200"
                          type="text"
                          placeholder="Your email address"
                        />
                      </div>
                    ...
                    <div className="w-full flex items-center">
                      <button
                        ...
                        className="w-40 p-3 bg-black rounded-lg  flex items-center justify-center gap-x-2 text-white"
                      >
                        {loading ? (
                          <CircularProgress
                            className=" text-white font-extrabold"
      ...
      >
        <div className=" w-full px-5  sm:px-5  h-full bg-transparent flex  items-center justify-center">
          <div
            style={{ width: 900 }}
            className=" h-auto nav-background flex items-center flex-col justify-between px-5 rounded-xl gap-y-10 py-10 "
          >
            <h1 className=" text-white text-center w-full">
              Choose you own avatar
            </h1>
            <div className="  w-full items-center justify-center h-full grid grid-cols-3 sm:grid-cols-4 gap-5">
              <div className=" flex items-center justify-center ">
                <Image
                  ...
                  className={
                    avat1
                      ? " border-3 border-transparent outline outline-1 outline-orange-400 rounded-full cursor-pointer"
            ...
            <div className=" flex items-center w-full  gap-x-4 justify-end">
              <button
                ...
                className=" p-1 px-4  outline outline-1 outline-orange-500 py-2 rounded-md w-full sm:w-40 flex items-center justify-center gap-3 shadow-2xl text-white"
              >
                <span>cancel</span>
              </button>
              <button
                ...
                className=" p-1 px-4  bg-orange-500 py-2 rounded-md w-full sm:w-40 flex items-center justify-center gap-3 shadow-2xl text-white"
              >
                <span>apply</span>
              </button>
            </div>
