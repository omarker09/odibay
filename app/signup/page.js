...
export default function SignUp() {
    ...
    function handleRegister() {
        ...
        if (!email || !password || !password2 || !username) {
            ...
            setLoading(true);
            axios.post("http://localhost:3002/api/v1/auth/rg", {
                email: email,
                password: password,
                username: username
            }, {
    ...
    return (
        <div className=' flex w-full flex-col justify-between h-auto'>
            ...
            <div className=' bg-slate-100 w-full h-auto flex py-10 items-center justify-center'>
                <div style={{ width: 650 }} className=" bg-white flex flex-col justify-between gap-y-5 shadow-2xl p-8">
                    <div>
                        <Image
                            src={gixiLogo}
                            height={150}
                    ...
                    <div className=" flex flex-col h-auto gap-y-4 w-full">
                        ...
                        <div className=" flex flex-col gap-y-3 w-full">
                            ...
                            <input value={username} onChange={(e) => { setUsername(e.target.value) }} className=" p-3 border-none outline outline-1  outline-gray-300 rounded-md" type="text" placeholder="Your username" />
                        </div>
                        <div className=" flex flex-col h-auto gap-y-3 w-full">
                            ...
                            <div className="outline outline-1 px-3 flex focus:focus:outline-gray-700 justify-between items-center outline-gray-300 rounded-md">
                                ...
                                }} className=" py-3 border-none outline-none  w-full" type={hideEye ? "text" : "password"} placeholder="Your password" />
                            ...
                            <div className="outline outline-1 px-3 flex focus:focus:outline-gray-700 justify-between items-center outline-gray-300 rounded-md">
                                ...
                                }} className=" py-3 border-none outline-none  w-full" type={hideEye2 ? "text" : "password"} placeholder="Confirm Your password" />
                    ...
                    <button onClick={() => { handleRegister() }} className="w-40 p-3 bg-black rounded-md flex items-center justify-center gap-x-2 text-white">
                        {loading ? <CircularProgress className=" text-white font-extrabold" size={20} /> : <span style={{ fontSize: 15 }} className=" text-white ">Sign Up</span>}
                    </button>
                </div>
            </div>
