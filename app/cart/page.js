    ...
    <div className=" flex w-full flex-col justify-between h-auto">
      ...
      >
        <div className=" w-full">
          <h1
            className={
              theme !== "dark" ? " text-black text-3xl" : " text-white text-3xl"
            }
          >
            <LockIcon /> Your Secure Cart{" "}
          </h1>
        </div>
        <div className=" w-full gap-5 flex flex-col lg:flex-row ">
          <div className=" w-full gap-4 flex flex-col">
            <div className=" flex items-center justify-between border border-4 p-3 border-orange-400">
              <div>
                ...
                >
                  Get 2 Mystery Windows PC Games on Steam for only $1.90
                </p>
              </div>
              <div>
                <button className=" orange-background py-3 px-5 text-black rounded-md">
                  Add to Cart
                </button>
              </div>
            </div>
            <div className=" w-full flex gap-2 flex-col">
              <div className={cartData?.length < 1 ? "flex" : "hidden"}>
                <div
                  className={
                    theme !== "dark"
                      ? " w-full p-3 pr-6 flex items-center gap-3 rounded-lg bg-white box-shadow justify-center"
                      : " w-full p-3 pr-6 flex items-center gap-3 rounded-lg cart-box box-shadow justify-center"
                  }
                >
                  <h1
                    className={
              ...
              {cartData?.map((product, index) => {
                return (
                  <div
                    className={
                      theme !== "dark"
                        ? " w-full p-3 pr-6 flex items-center gap-3 rounded-lg bg-white box-shadow"
                        : " w-full p-3 pr-6 flex items-center gap-3 rounded-lg cart-box box-shadow"
                    }
                  >
            ...
            <div
              className={
                theme !== "dark"
                  ? "bg-white box-shadow w-full flex items-center justify-around rounded-lg p-3"
                  : "cart-box box-shadow w-full flex items-center justify-around rounded-lg p-3"
              }
            >
              <div className=" flex items-center justify-center text-center gap-1 p-3">
                ...
                >
                  ...
                  <CustomizedTooltips
                    size={15}
                    title="Gift this to friend"
                    description1="give this as a gift to your friend"
                    description2="via email address"
                  />
                </p>
              </div>
              ...
              <div className=" flex items-center justify-center text-center gap-1 p-3">
                <div className=" flex items-center">
                  <Image src={dzFlag} height={25} width={25} />
                </div>
                <span
                  className={
                    theme !== "dark"
          ...
          >
            ...
            <Link
              ...
              className=" orange-background uppercase w-full flex items-center justify-center text-center py-3 px-5 text-black rounded-md"
            >
              <LockIcon />
              <div className="uppercase w-full flex items-center justify-center text-center font-bold  text-black rounded-md">
                {" "}
                Proceed To Checkout
              </div>
            </Link>
