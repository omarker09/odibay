          ...
          <div className=" h-auto  w-full lg:w-64  ">
            ...
            <div className=" flex flex-col gap-4">
              ...
              <div className="bg-slate-100 flex flex-col  w-full  ">
                <span className="p-2 nav-background h-auto w-full text-white">
                  Filter BY PRICE
                </span>
                <div className="p-3 gap-3 flex-col w-full h-auto flex items-start">
                  ...
                  <button className=" bg-orange-400 p-2 w-full text-white">
                    FILTER
                  </button>
                </div>
              </div>
            ...
            >
              ...
              {arr.map((e) => {
                return (
                  <div
                    key={e.title}
                    className=" border-1 mr-2  border-gray-300  rounded-lg"
                  >
                    <Image
                      height={290}
                      width={290}
