...
const Alert = React.forwardRef(function Alert(props, ref) {
 ...
 function Regulerproducts() {
  ...
  return (
    <div className={theme !== "dark" ? ' flex bg-white duration-300 flex-col px-2 sm:px-10 md:px-16 lg:px-20 py-2  ' : ' flex cart-parent duration-300 flex-col px-2 sm:px-10 md:px-16 lg:px-20 py-2  '}>
      ...
      <div className=' w-full overflow-hidden  grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 duration-300  gap-4  py-3'>
        ...
        <Product id={2} img={pf} discount={20} title="RDR 2" oldprice={0} price={3500} category={"PS5 Games"} rating={4} width={290} height={290} />
        <Product id={3} img={gtv} discount={5} title="GTA V" price={2000} oldprice={0} category={"PS5 Games"} rating={5} width={290} height={290} />
