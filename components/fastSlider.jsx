...
function FastSlider() {
  ...
  return (
    <div
      className={
        theme !== "dark"
          ? "flex duration-300 flex-col bg-white py-2 px-2 gap-5 sm:px-10 md:px-16 lg:px-20 my-4"
          : "cart-parent duration-300 flex flex-col py-2 px-2 gap-5 sm:px-10 md:px-16 lg:px-20 my-4"
      }
    >
