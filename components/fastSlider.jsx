...
function FastSlider() {
    ...
    return (
        <div className={theme !== "dark" ? 'flex duration-300 flex-col bg-white py-4 px-2 gap-3 sm:px-10 md:px-16 lg:px-20' : 'cart-parent duration-300 flex flex-col py-4 px-2 gap-3 sm:px-10 md:px-16 lg:px-20'}>
